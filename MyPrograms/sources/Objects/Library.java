...
public class Library extends JFrame{
	//Quiz - write class, constructor, arrayList, iterate through and remove/add, compare strings/comparator
 ...
 activePerson+" currently has nothing checked out under "+activePerson.getGenderPossessivePronoun()+" name.":
 activePerson+" has the following titles checked out under "+activePerson.getGenderPossessivePronoun()+" name.";
